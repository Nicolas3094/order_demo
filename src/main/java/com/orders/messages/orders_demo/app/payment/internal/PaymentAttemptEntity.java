...
public class PaymentAttemptEntity {
    ...
    public PaymentAttemptEntity(UUID id, OrderEntity order, PaymentProvider provider, String idempotencyKey) {
        this.id = id;
        this.order = order;
    ...
    public PaymentAttemptEntity(OrderEntity order, PaymentProvider provider, String idempotencyKey) {
        this.order = order;
        this.amount = order.getAmountTotal();
        this.provider = provider;
        this.idempotencyKey = idempotencyKey;
